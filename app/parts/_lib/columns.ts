...
export const ALL_COLUMNS: ColumnMeta[] = [
  { id: "partNumber",            label: "Part Number",   dataType: "text",        sortable: true,  filterable: true,  align: "left",   defaultWidth: "min-w-[120px] max-w-[160px]" },
  { id: "partName",              label: "Part Name",     dataType: "text",        sortable: true,  filterable: true,  align: "left",   defaultWidth: "min-w-[200px] max-w-[280px]" },
  { id: "partType",              label: "Type",          dataType: "categorical", sortable: true,  filterable: true,  align: "left",   defaultWidth: "w-24" },
  { id: "procurementCategory",   label: "Proc",          dataType: "categorical", sortable: true,  filterable: true,  align: "left",   defaultWidth: "w-28" },
  { id: "material",              label: "Material",      dataType: "categorical", sortable: true,  filterable: true,  align: "left",   defaultWidth: "min-w-[140px]" },
  { id: "materialForm",          label: "Form",          dataType: "categorical", sortable: true,  filterable: true,  align: "left",   defaultWidth: "w-24" },
  { id: "vendor",                label: "Vendor",        dataType: "categorical", sortable: true,  filterable: true,  align: "left",   defaultWidth: "min-w-[140px]" },
  { id: "vendorPartNumber",      label: "Vendor Part #", dataType: "text",        sortable: true,  filterable: true,  align: "left",   defaultWidth: "min-w-[120px]" },
  { id: "routing",               label: "Routing",       dataType: "routing",     sortable: false, filterable: true,  align: "left",   defaultWidth: "flex-1 min-w-[160px]" },
  { id: "buildableCount",        label: "Buildable",     dataType: "numeric",     sortable: true,  filterable: true,  align: "right",  defaultWidth: "w-20" },
  { id: "stockCount",            label: "Stock",         dataType: "numeric",     sortable: true,  filterable: true,  align: "right",  defaultWidth: "w-20" },
  { id: "inventoryLocation",     label: "Location",      dataType: "text",        sortable: true,  filterable: true,  align: "left",   defaultWidth: "min-w-[120px] max-w-[180px]" },
  { id: "stockSize",             label: "Stock Size",    dataType: "text",        sortable: true,  filterable: true,  align: "left",   defaultWidth: "min-w-[120px]" },
  ...
  { id: "assembliesUsedInCount", label: "Used In",       dataType: "numeric",     sortable: false, filterable: true,  align: "right",  defaultWidth: "w-16" },
