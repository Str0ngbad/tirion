...
import { deactivateProcurementCategory } from "@/lib/procurement-categories/service";
...
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const result = await deactivateProcurementCategory(procurementCategoryId, userId);
