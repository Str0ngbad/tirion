...
import { reactivateProcessTypeSubStatus } from "@/lib/process-type-sub-statuses/service";
...
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const result = await reactivateProcessTypeSubStatus(processTypeSubStatusId, actorUserId);
