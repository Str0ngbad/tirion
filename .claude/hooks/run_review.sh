...
CLAUDE_CMD=(claude --agent code-reviewer -p "Review the most recent commit and append your review to .claude/reviews/log.md per the format in your system prompt." --allowedTools "Read,Grep,Glob,Bash")
